#!/usr/bin/env python3
# v100.py - Rilis UI Carbon Final: Fix Sorting Order
# Deskripsi: Gateway IEC 61850 ke IEC 60870-5-104.
# UI Update v50:
# - FIX: Urutan Event Log saat refresh halaman (History) kini konsisten
#   dengan Live Update (Terbaru selalu di Paling Atas).
# - Header Description, Logo, dan fitur lainnya tetap dipertahankan.
