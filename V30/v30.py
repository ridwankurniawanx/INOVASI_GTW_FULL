#!/usr/bin/env python3
# v30.py - Rilis Final dengan Kolom Signal Name
...
def process_data_update(ied_id, key, data):
    ...
    # --- MODIFIKASI DIMULAI: Gunakan timestamp dari laporan jika ada ---
...
async def main_async():
    ...
    logging.info(f"Gateway v30 dimulai. Tekan Ctrl+C untuk berhenti.")
